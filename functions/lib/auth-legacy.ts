// Legacy password + HMAC token auth helpers.
// Kept only as a transitional fallback (see lib/auth.ts). The old password
// flow is being replaced by Clerk, and this module can be deleted once the
