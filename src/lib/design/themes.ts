...
const MOSS_FONT_URL =
  'https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,400;9..144,500;9..144,600&family=Noto+Serif+Thai:wght@400;500;600&display=swap'
...
const mcky: Theme = {
  id: 'mcky',
  label: 'MCKY',
  description: 'สไตล์บ้าน — กระดาษ + ขอบดำ + amber + เงาแข็ง',
  character: 'mcky',
  modes: ['light', 'dark'],
  fonts: MCKY_FONTS,
  ...
  dark: {
    ...
    '--primary': '#ffe066',
    '--primary-foreground': '#171712',
    '--secondary': '#2c2c27',
    '--secondary-foreground': '#c0c0b4',
    '--muted': '#2c2c27',
    '--muted-foreground': '#c0c0b4',
    '--accent': '#9b5de5',
    '--accent-foreground': '#171712',
    '--destructive': '#ff6b6b',
    '--destructive-foreground': '#171712',
    '--success': '#06d6a0',
    '--success-foreground': '#171712',
    '--warning': '#ff9f43',
    '--warning-foreground': '#171712',
    '--info': '#7a9ff0',
    '--info-foreground': '#171712',
    '--border': '#f5f5f0',
    '--input': '#f5f5f0',
    '--ring': '#f5f5f0',
    '--sidebar': '#242420',
    ...
    '--sidebar-accent': '#ffe066',
    '--sidebar-accent-foreground': '#171712',
    '--sidebar-border': '#f5f5f0',
    '--sidebar-ring': '#f5f5f0',
    '--radius': '0.25rem',
    '--pin-color': '#ffe066',
  },
...
const characterThemes: Theme[] = [glitchpage, crt, claude, rack, noc, min, brut, moss, mcky, dusk, blueprint, noir]

export const themes: Theme[] = [...baseThemes, ...characterThemes]

export const defaultTheme: Theme = claude
