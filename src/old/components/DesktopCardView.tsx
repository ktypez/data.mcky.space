...
import type { Client, FilterKey } from '@/types/index'
import ClientCopyButton from '@/old/components/ClientCopyButton'
import EmptyState from '@/old/components/EmptyState'
import { formatDate } from '@/lib/utils'
import ClientCardBadges, { PlaceholderAvatar } from '@/old/components/ClientCardBadges'
import BadgeTag from '@/old/components/BadgeTag'
import LoadMore from '@/old/components/LoadMore'
