...
import { TableSkeletonLoader } from '@/old/components/TableSkeletonLoader'
...
import { useClientCopy } from '@/old/hooks/useClientCopy'
import { useRoutePlanner } from '@/old/hooks/useRoutePlanner'
import { updateClient } from '@/lib/storage'
import { slideLeft, slideRight, spring, springSmall } from '@/lib/motion'
import type { Client, FilterKey, RouteData, ViewMode } from '@/types/index'
...
const ClientDetail = lazyLoad(() => import('@/old/components/ClientDetail'))
const SelectionToolbar = lazyLoad(() => import('@/old/components/SelectionToolbar'))
const RouteModal = lazyLoad(() => import('@/old/components/RouteModal'))
const DesktopTableView = lazyLoad(() => import('@/old/components/DesktopTableView'))
const DesktopCardView = lazyLoad(() => import('@/old/components/DesktopCardView'))
const MobileCardList = lazyLoad(() => import('@/old/components/MobileCardList'))
const SwUpdateToast = lazyLoad(() => import('@/old/components/SwUpdateToast'))
